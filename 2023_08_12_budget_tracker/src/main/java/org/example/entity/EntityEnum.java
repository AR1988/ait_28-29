...
public enum EntityEnum {
    ...
    //todo fix it
//    TRANSACTION_TEST(
//            Path.of(DB_TEST_SOURCE_DIR, DB_TRANSACTION_DIR_NAME, DB_KEY_TABLE_NAME),
//            Path.of(DB_TEST_SOURCE_DIR, DB_TRANSACTION_DIR_NAME, DB_TRANSACTION_TABLE_NAME),
//            Path.of(DB_TEST_SOURCE_DIR, DB_TRANSACTION_DIR_NAME, DB_TRANSACTION_CATEGORY_REF_TABLE_NAME)),
//
//    CATEGORY_TEST(Path.of(DB_TEST_SOURCE_DIR, DB_CATEGORY_DIR_NAME, DB_KEY_TABLE_NAME),
//            Path.of(DB_TEST_SOURCE_DIR, DB_CATEGORY_DIR_NAME, DB_CATEGORY_TABLE_NAME),
//            Path.of(DB_TEST_SOURCE_DIR, DB_CATEGORY_DIR_NAME, DB_CATEGORY_SUBCATEGORY_REF_TABLE_NAME)),
//
//    SUB_CATEGORY_TEST(Path.of(DB_TEST_SOURCE_DIR, DB_SUB_CATEGORY_DIR_NAME, DB_KEY_TABLE_NAME),
//            Path.of(DB_TEST_SOURCE_DIR, DB_SUB_CATEGORY_DIR_NAME, DB_SUB_TABLE_NAME),
//            Path.of(DB_TEST_SOURCE_DIR, DB_CATEGORY_DIR_NAME, DB_CATEGORY_SUBCATEGORY_REF_TABLE_NAME));
